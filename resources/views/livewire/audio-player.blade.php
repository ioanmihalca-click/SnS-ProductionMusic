<div class="relative" x-data="{
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center justify-center w-8 h-8 rounded-full bg-red-500/20">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-red-500"
                                    :class="{ 'animate-pulse': currentTrack === index && isPlaying }" fill="none"
    ...
    <button @click="currentTrack = null; wavesurfer?.pause()" 
        ...
        <span class="absolute px-2 py-1 text-xs transition-opacity duration-300 -translate-y-1/2 bg-gray-900 rounded opacity-0 group-hover:opacity-100 right-10 top-1/2 whitespace-nowrap">
            Close Player (ESC)
        </span>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center flex-1 space-x-4">
                ...
                <div class="flex flex-col min-w-0">
                    ...
                    <span class="text-xs text-gray-400 truncate" x-text="tracks[currentTrack]?.artist || 'Unknown Artist'"></span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end flex-1 space-x-4">
                ...
                <!-- License Button -->
                <button class="px-3 py-1.5 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 transition-colors">
                    License
                </button>
            </div>
        </div>
        ...
        <div class="relative">
            <div x-ref="waveform" @click="seekTo($event)"
                ...
                <div x-show="loading" 
                    ...
                    <div class="w-8 h-8 border-4 border-red-500 rounded-full border-t-transparent animate-spin"></div>
                </div>
            </div>
