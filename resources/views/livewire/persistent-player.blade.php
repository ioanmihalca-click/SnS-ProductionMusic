<div class="relative" x-data="audioPlayer(@entangle('tracks').defer)" x-init="init()">
    <div x-cloak x-show="currentTrack !== null" 
        ...
        <button @click="closePlayer()"
            ...
            <span
                class="absolute px-2 py-1 text-xs transition-opacity duration-300 -translate-y-1/2 bg-gray-900 rounded-md shadow-lg opacity-0 group-hover:opacity-100 right-10 top-1/2 whitespace-nowrap backdrop-blur-sm">
                Close Player (ESC)
            </span>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center flex-1 space-x-4">
                        <div class="relative flex-shrink-0 w-12 h-12 overflow-hidden rounded-lg group">
                            <img :src="tracks[currentTrack]?.artwork" :alt="tracks[currentTrack]?.name"
                        ...
                        <div class="flex flex-col min-w-0">
                            <span
                                class="text-sm font-medium text-white truncate transition-colors duration-200 hover:text-red-500"
                                x-text="tracks[currentTrack]?.name"></span>
                            <span
                                class="text-xs text-gray-400 truncate transition-colors duration-200 hover:text-gray-300"
                                x-text="'Snow N Stuff'"></span>
                        </div>
                    </div>
